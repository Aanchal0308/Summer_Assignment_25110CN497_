...
public class program109
{
    ...
    public static void addBook() 
    {
        ...
        library.add(newBook);
        System.out.println("SUCCESS: Book \"" + title + "\" added to the library catalog.");
    }
    ...
    public static void issueBook() 
    {
        ...
        for (Book b : library) 
        {
            if (b.bookId == id) 
            {
                ...
                {
                    b.isIssued = true;
                    System.out.println("SUCCESS: Book \"" + b.title + "\" has been issued to you.");
                }
                return; 
            }
        }
    ...
    public static void returnBook() 
    {
        ...
        for (Book b : library) 
        {
            if (b.bookId == id) 
            {
                ...
                {
                    b.isIssued = false;
                    System.out.println("SUCCESS: Book \"" + b.title + "\" returned successfully.");
                }
                return;
            }
        }
    ...
    // Function to search for a book by title (using basic String functions)
    public static void searchBook() {
        System.out.print("Enter the title (or keyword) to search: ");
        ...
        for (Book b : library) 
        {
            ...
            {
                String status = b.isIssued ? "Borrowed" : "Available";
                System.out.println("ID: " + b.bookId + " | " + b.title + " by " + b.author + " [" + status + "]");
                found = true;
            }
        }
